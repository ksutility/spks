...
def xpath(file_name=''):
    '''
    goal:
        define base folder for 
    '''
    xpath=C_SET().base_folder + '\\' #'d:\\ks\\0-file\\' #or xpath=os.getcwd()+"\\file"
    if xpath!='d:\\ks\\0-file\\' : print ('error = > xpath')
