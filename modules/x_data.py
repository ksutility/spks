...
x_data={
    ...
    'doc_num':{ #db
        'a':{
            ...
            'steps':{
                'pre':{'tasks':'prj,prj_id,prj_name,sub_p,sub_p_name,step_x1,step_x2,step,step_name,dspln,dspln_name,doc_t,doc_t_name','xjobs':'dccm','title':'ورود اطلاعات','app_keys':'','app_titls':'','oncomplete_act':''},
